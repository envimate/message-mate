...
//TODO: should be able to be cleaned up
@RequiredArgsConstructor(access = AccessLevel.PRIVATE)
public final class PipeBuilder_old<T> {
    ...
    public static <T> PipeBuilder_old<T> aPipe() {
        return new PipeBuilder_old<>();
    }

    public static <T> PipeBuilder_old<T> aPipeForClass(final Class<T> tClass) {
        return new PipeBuilder_old<>();
    }

    public PipeBuilder_old<T> withDeliveryType(@NonNull final DeliveryType deliveryType) {
        configuration.setDeliveryType(deliveryType);
        return this;
    }

    public PipeBuilder_old<T> withConfiguration(@NonNull final PipeConfiguration pipeConfiguration) {
        this.configuration = pipeConfiguration;
        return this;
    }

    public PipeBuilder_old<T> withACustomDeliveryStrategyFactory(final DeliveryStrategyFactory<T> deliveryStrategyFactory) {
        this.deliveryStrategyFactory = deliveryStrategyFactory;
        return this;
    }

    public PipeBuilder_old<T> withACustomMessageAcceptingStrategyFactory(
    ...
    public PipeBuilder_old<T> withACustomMessageTransportFactory(
    ...
    public PipeBuilder_old<T> withStatisticsCollector(final StatisticsCollector statisticsCollector) {
    ...
    public Pipe<T> build() {
        ...
        return new PipeImpl<>(null, null, subscribers);
    }
