...
import static com.envimate.messageMate.soonToBeExternal.usecaseCreating.SingletonObjectUseCaseFactory.singletonObjectUseCaseFactory;
...
public final class ObjectBasedUseCaseInvokerImpl implements UseCaseInvoker {
    private final UseCaseInvocationInformation useCaseInvocationInformation;
    private final EventFactory eventFactory;

    public static ObjectBasedUseCaseInvokerImpl objectBasedUseCaseInvoker(final Object useCaseInstance) {
        final Method method = locateUseCaseMethod(useCaseInstance);
        final Class<?> eventClass = getFirstParameter(method);
        final EventFactory eventFactory = createFactoryFor(eventClass);
        return objectBasedUseCaseInvoker(useCaseInstance, eventFactory);
    }

    public static ObjectBasedUseCaseInvokerImpl objectBasedUseCaseInvoker(final Object useCaseInstance,
                                                                          final EventFactory eventFactory) {
        final UseCaseFactory useCaseFactory = singletonObjectUseCaseFactory(useCaseInstance);
        final Method method = locateUseCaseMethod(useCaseInstance);
        ...
        return new ObjectBasedUseCaseInvokerImpl(invocationInformation, eventFactory);
    }
    ...
    private static Method locateUseCaseMethod(final Object useCaseInstance) {
        final Class<?> useCaseClass = useCaseInstance.getClass();
