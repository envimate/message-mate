...
package com.envimate.messageMate.qcec.domainBus.answer;

import com.envimate.messageMate.qcec.domainBus.AnswerStep1Builder;
import com.envimate.messageMate.qcec.domainBus.AnswerStep2Builder;
...
import static com.envimate.messageMate.qcec.domainBus.answer.ConstraintAnswerImpl.constraintAnswer;
import static com.envimate.messageMate.qcec.domainBus.answer.EventAnswerImpl.eventAnswer;
import static com.envimate.messageMate.qcec.domainBus.answer.QueryAnswerImpl.queryAnswer;
...
public final class AnswerBuilder<T> implements AnswerStep1Builder<T>, AnswerStep2Builder<T> {
    ...
    @Override
    public AnswerStep2Builder<T> until(final Object event) {
        return until(event.getClass(), o -> o.equals(event));
    }
