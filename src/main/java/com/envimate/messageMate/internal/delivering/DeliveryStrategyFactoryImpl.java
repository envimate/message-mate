...
public final class DeliveryStrategyFactoryImpl<T> implements DeliveryStrategyFactory<T> {
    private final DeliveryType deliveryType;
    private final AsynchronousDeliveryStrategyConfiguration configuration;
    ...
    public DeliveryStrategy<T> createNew(final DeliveryEventLoop<T> eventLoop) {
        switch (deliveryType) {
            ...
            default:
                throw new UnknownDeliveryTypeException("Unknown delivery type " + deliveryType);
        }
    }
