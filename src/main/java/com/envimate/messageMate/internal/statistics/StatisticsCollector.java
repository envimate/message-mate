...
public interface StatisticsCollector {
    ...
    void informMessageDropped();

    void informMessageReplaced();

    void informMessageForgotten();

    void informMessageDeliverySuccess();

    void informMessageDeliveryFailed();

    MessageStatistics getCurrentStatistics();

    void informMessageQueued();

    void informMessageDequeued();

    void informTransportStarted();

    void informMessageTransportFinished();

    void informDeliveryStarted();
}
