...
public final class DelegatingChannelExceptionHandlerForAcceptingChannel<T> implements ChannelExceptionHandler<T> {
    ...
    public static <T> DelegatingChannelExceptionHandlerForAcceptingChannel<T> delegatingChannelExceptionHandlerForAcceptingChannel(final MessageBusExceptionHandler messageBusExceptionHandler) {
        return new DelegatingChannelExceptionHandlerForAcceptingChannel<>(messageBusExceptionHandler);
    }
