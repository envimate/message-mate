...
public final class ChannelMessageBusTestValidations {
    ...
    public static void assertExpectedReceiverReceivedAllMessages(final ChannelMessageBusSutActions sutActions, final TestEnvironment testEnvironment) {
    ...
    public static void assertAllMessagesHaveContentChanged(final ChannelMessageBusSutActions sutActions, final TestEnvironment testEnvironment) {
    ...
    public static void assertReceiverReceivedOnlyValidMessages(final TestEnvironment testEnvironment) {
        final List<?> expectedReceivedMessages = (List<?>) testEnvironment.getProperty(MESSAGES_SEND);
        final List<SimpleTestSubscriber<?>> receivers = getExpectedReceiversAsSubscriber(testEnvironment);
        for (final SimpleTestSubscriber<?> receiver : receivers) {
            final List<?> receivedMessages = receiver.getReceivedMessages();
    ...
    public static void assertSutWasShutdownInTime(final ChannelMessageBusSutActions sutActions, final TestEnvironment testEnvironment) {
    ...
    public static void assertSutIsShutdown(final ChannelMessageBusSutActions sutActions, final TestEnvironment testEnvironment) {
        final boolean isShutdown = sutActions.isShutdown(testEnvironment);
        assertTrue(isShutdown);
    }
    ...
    public static void assertSutHasExpectedFilter(final ChannelMessageBusSutActions sutActions, final TestEnvironment testEnvironment) {
        final List<?> expectedFilter = (List<?>) testEnvironment.getProperty(EXPECTED_FILTER);
