...
/**
 * Interface defining methods to add additional success response classes.
 *
...
public interface AnswerOrStepMessageFunctionBuilder<R, S> {
    ...
    /**
     * Adds an additional success response class for the currently processed request.
     *
     * @param responseClass the additional success response class
