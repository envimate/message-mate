...
/**
 * Interface defining the final step of building a {@code MessageFunction}.
 *
 * @param <R> the supertype of requests
 * @param <S> the supertype of responses
 */
public interface Step9FinalMessageFunctionBuilder<R, S> {

    /**
     * Creates the defined {@code MessageFunction}.
     *
     * @return the created {@code MessageFunction}
     */
