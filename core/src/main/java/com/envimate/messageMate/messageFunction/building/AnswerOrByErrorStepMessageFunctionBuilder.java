...
/**
 * Interface defining methods to add additional error response classes.
 *
...
public interface AnswerOrByErrorStepMessageFunctionBuilder<R, S> {
    /**
     * Adds an additional error response class for the currently processed request.
     *
     * @param responseClass the additional error response class
