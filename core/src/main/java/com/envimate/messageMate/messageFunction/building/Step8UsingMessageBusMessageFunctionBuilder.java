...
/**
 * Interface defining the step of building a {@code MessageFunction}, which sets the {@code MessageBus} to be used to send
...
public interface Step8UsingMessageBusMessageFunctionBuilder<R, S> {
    ...
    /**
     * Sets the {@code MessageBus} to send requests and receive responses.
     *
