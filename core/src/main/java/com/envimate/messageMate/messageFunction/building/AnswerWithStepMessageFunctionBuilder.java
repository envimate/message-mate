...
/**
 * Interface starting the definition of request-response pairs.
 *
...
public interface AnswerWithStepMessageFunctionBuilder<R, S> {
    ...
    /**
     * Starts a new mapping of the a request class to potential response classes.
     *
     * @param requestClass the class of the request
     * @param <U>          type of the request that must extend the request supertype
