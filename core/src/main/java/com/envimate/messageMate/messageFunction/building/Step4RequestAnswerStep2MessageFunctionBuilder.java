...
/**
 * Interface defining the step of building a {@code MessageFunction}, in which a potential responses for the currently
 * processed request are set or a new request-response pair definition is started.
 *
