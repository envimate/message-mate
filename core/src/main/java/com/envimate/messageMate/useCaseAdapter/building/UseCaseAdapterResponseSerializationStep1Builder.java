...
public interface UseCaseAdapterResponseSerializationStep1Builder {
     ...
     */
    UseCaseAdapterResponseSerializationStep2Builder<Object> serializingResponseObjectsThat(Predicate<Object> filter);
     ...
     * {@link UseCaseAdapterResponseSerializationStep1Builder#serializingResponseObjectsThat(Predicate)},
     * {@link UseCaseAdapterResponseSerializationStep1Builder#serializingResponseObjectsOfType(Class)}, etc. matches the use case return value.
     *
     * @param mapper a {@link ResponseMapper}
     * @return the next step in the fluent builder
     */
    UseCaseAdapterExceptionSerializationStep1Builder serializingResponseObjectsByDefaultUsing(ResponseMapper<Object> mapper);
     ...
     * @return the next step in the fluent builder
     */
    default UseCaseAdapterExceptionSerializationStep1Builder throwingAnExceptionIfNoResponseMappingCanBeFound() {
