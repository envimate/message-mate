...
public interface UseCaseAdapterDeserializationStep1Builder {
     ...
     */
    default <T> UseCaseAdapterDeserializationStep2Builder<T> mappingRequestsToUseCaseParametersOfType(final Class<T> type) {
     ...
     * {@link UseCaseAdapterDeserializationStep1Builder#mappingRequestsToUseCaseParametersThat(BiPredicate)},
     * {@link UseCaseAdapterDeserializationStep1Builder#mappingRequestsToUseCaseParametersOfType(Class)}, etc. matches the request.
     *
     * @return the next step in the fluent builder
     */
