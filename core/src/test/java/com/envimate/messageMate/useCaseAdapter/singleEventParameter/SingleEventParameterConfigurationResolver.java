...
public class SingleEventParameterConfigurationResolver extends AbstractTestConfigProvider {
    ...
    private static final Class<SingleParameterEvent> EVENT = SingleParameterEvent.class;
    ...
    protected Object testConfig() {
        ...
        return testUseCase(USE_CASE_CLASS, EVENT, messageBusSetup, instantiationFunction, parameterMapping, requestObject, expectedResponse);
    }
}
