...
public final class TestUseCase {
    ...
    @Getter
    private final Consumer<UseCaseAdapterResponseSerializationStep1Builder> serializationEnhancer;
    @Getter
    ...
    public static TestUseCase testUseCase(final Class<?> useCaseClass,
                                          ...
                                          final Consumer<UseCaseAdapterResponseSerializationStep1Builder> serializationEnhancer,
    ...
    public static TestUseCase testUseCase(final Class<?> useCaseClass,
        ...
        final Function<TestEnvironment, Object> requestObjectSupplier = testEnvironment -> requestObject;
        final Function<TestEnvironment, Object> expectedResultSupplier = testEnvironment -> expectedResult;
        final Consumer<UseCaseAdapterResponseSerializationStep1Builder> serializationEnhancer = b -> {
    ...
    public void defineSerialization(UseCaseAdapterResponseSerializationStep1Builder serializationBuilder) {
