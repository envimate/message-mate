...
import static com.envimate.messageMate.useCases.severalParameter.SeveralParameterUseCaseCombinedRequest.severalParameterUseCaseCombinedRequest;
import static com.envimate.messageMate.useCases.severalParameter.SeveralParameterUseCaseRequest1.severalParameterUseCaseRequest1;
import static com.envimate.messageMate.useCases.severalParameter.SeveralParameterUseCaseRequest2.severalParameterUseCaseRequest2;
...
public class SeveralParameterInvocationConfiguration implements UseCaseInvocationConfiguration {
        ...
        return requestDeserializationStep1Builder -> {
            requestDeserializationStep1Builder
                    ...
                    .using((targetType, map) -> {
                        ...
                        return severalParameterUseCaseRequest1(intParameter, booleanParameter);
                    })
                    ...
                    .using((targetType, map) -> {
                        ...
                        return severalParameterUseCaseRequest2(stringParameter, objectParameter);
                    });
        };
    }
    ...
    public RequestExpectedResultTuple createRequestExpectedResultTuple() {
        ...
        final SeveralParameterUseCaseCombinedRequest requestObject = severalParameterUseCaseCombinedRequest(intParam,
                booleanParam, objectParam, stringParam);
        final SeveralParameterUseCaseResponse expectedResult = severalParameterUseCaseResponse(intParam, booleanParam,
    ...
    public InstantiationBuilder applyCustomUseCaseMethodCallingConfiguration(final Step3Builder<?> step3Builder) {
        return step3Builder.callingBy((useCase, event, callingContext) -> {
            ...
            final SeveralParameterUseCaseRequest1 request1 = severalParameterUseCaseRequest1(intParameter, booleanParameter);
            ...
            final SeveralParameterUseCaseRequest2 request2 = severalParameterUseCaseRequest2(stringParameter, objectParameter);
